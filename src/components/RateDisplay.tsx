        ...
        <div className="h-screen w-screen bg-gray-50 flex flex-col">
            ...
            <div className="flex-1 overflow-hidden p-2 sm:p-4 lg:p-6">
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-full flex flex-col">
                    ...
                    {/* Mobile table only */}
                    <div className="overflow-x-auto p-2 md:hidden">
                        <table className="table-auto w-full border border-gray-200 text-sm">
                            <thead className="bg-gray-100">
                                <tr>
                                    <th className="px-2 py-1 border text-left">Flag</th>
                                    <th className="px-2 py-1 border text-left">Currency</th>
                            ...
                            <tbody>
                                {rates.map((rate) => (
                                    <tr key={rate.id} className="hover:bg-blue-50 transition-colors">
                                        ...
                                        <td className="px-2 py-1 border">{rate.Currency}</td>
                                        <td className="px-2 py-1 border font-mono font-bold">{rate.Cur}</td>
                                        <td className="px-2 py-1 border text-right font-mono font-bold">
                                            {rate.Rate}
                                        </td>
                                    </tr>
                                ))}
